...
network_params = {
    ...
    "p_syn_astro": 0.0,  # synapse-astrocyte pairing probability
...
def connect_astro_network(nodes_ex, nodes_in, nodes_astro, nodes_noise, scale=1.0):
    ...
    conn_params_e = {"rule": "pairwise_bernoulli", "p": network_params["p"]/scale}
    syn_params_e = {
    ...
    # Test symmetric Bernoulli
    conn_params_sym = {
        "rule": "symmetric_pairwise_bernoulli", "p": 0.5*network_params["p"]/scale,
    ...
    nest.Connect(nodes_ex, nodes_ex + nodes_in, conn_params_sym, syn_params_sym)
